...
and `collecting_rows()` gather those artifacts — a chart, a table of rows — so
they can travel beside the reply instead of through the model's context, where
either would cost more than it could ever be worth as text.
"""
...
__all__ = [
    ...
    "Rows",
    "acting", "actor", "collecting", "collecting_rows", "dispatch", "specs",
    "tool",
]
